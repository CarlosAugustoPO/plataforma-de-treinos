...
const AutenticarTrocarSenhaUnauthTemplate = dynamic(
  () =>
    import(
      'src/templates/unauth/AutenticarTrocaDeSenha/Email/index'
    ),
...
export default function AutentinticarTrocaDeSenha() {
  ...
  return (
    <MyHead>
      ...
      {status === 'unauthenticated' && (
        <AutenticarTrocarSenhaUnauthTemplate
