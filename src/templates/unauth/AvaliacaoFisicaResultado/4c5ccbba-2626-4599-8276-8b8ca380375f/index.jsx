...
function ResultadoAvaliacaoFisica() {
  const dadosDaAvaliacaoAtual = {
    ...
    motivoDeParadaDaUltimaVez: 'Desanimo',
    tempoDeParadaDaUltimaVez: 'Não informado',
    quantidadeDeTreinosPorSemana: '5 vezes',
    horarioDeTreinoMusculacao: '05h30',
    horarioDesejadoDeTreinoMusculacao: '5h30',
    ...
    estrategiasDeLazer: '',
    rotinaDeTrabalho: 'sendetário',
    meioDeTransporteParaTrabalho: '',
    problemaDeSaude: 'Hpotiroidismo',
    medicamento: 'Puran t4 75mg',
    esteroidesAnabolicos: 'Não',
    fumaBebidasAlcoolicas: 'Ingere alcool socialmente',
    frequenciaAlcool: '',
    lesaoPassada: 'Não',
    limitacaoFisica: 'Dor na lombar exporádica durante o dia',
    amamentando: 'Não',
    cirurgiaPassada: 'Laqueadura',
    ...
    informacoesAdicionais:
      'Faz frenagem 2 vezes na semana, faz um treino em cada diariamente, de segunda a segunda. Não fará apenas quando estiver com dor.',
  };
