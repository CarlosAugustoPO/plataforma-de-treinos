...
function ResultadoAvaliacaoFisica() {
  const dadosDaAvaliacaoAtual = {
    nome: 'Clara Conti Araújo',
    idade: 49,
    altura: 1.64,
    email: 'claraconti@gmail.com',
    dataDaAvaliação: '24/03/2024',
    dataDeNascimento: '02/07/1974',
    genero: 'feminino',
    objetivoEstetico: 'Definição',
    pontosFracosEsteticos: 'Abdômen e quadril',
    pretendeCorrer: 'Não',
    objetivosComCorrida: '',
    pretendeMelhorarFlexibilidade: '',
    objetivosComFlexibilidade: 'hide',
    comoPossoTeAjudar: 'hide',
    haQuantoTempoTreinaMusculacao: '10 anos',
    motivoDeParadaDaUltimaVez: 'Gestação',
    tempoDeParadaDaUltimaVez: '15 anos',
    quantidadeDeTreinosPorSemana: '4 vezes',
    quantidadeDeTreinosPorSemanaPretendido: '3 vezes',
    horarioDeTreinoMusculacao: '22h00',
    horarioDesejadoDeTreinoMusculacao: '11h00',
    musculosPreferidosDeTreinoMusculacao: 'Sem preferências',
    exerciciosComDificuldades: 'Exercícios de ombro, crucifixo',
    ...
    ultimoTreino: '8 horas atrás',
    ultimoTreinoDescricao: 'Quadríceps e glúteo',
    ultimaRefeicao: 'Pão com ovos, queijo e café com leite',
    tempoUltimaRefeicao: '90 minutos atrás',
    horaDeDormir: '01:30',
    horaDeAcordar: '06:30',
    qualidadeDoSono: 'Boa',
    rotinaDiariaDetalhes: '',
    humorDiario: 'ansioso',
    estrategiasContraEstresse: 'comer doces',
    estrategiasDeLazer: 'Bater perna',
    rotinaDeTrabalho: '',
    meioDeTransporteParaTrabalho: '',
    problemasDeSaude: 'Sem problemas de saúde diagnosticados',
    tomaMedicamento: 'Sem medicamentos',
    usaEsteroides: 'Não',
    frequenciaAlcool: 'Não bebe',
    frequenciaFumo: 'Não fuma',
    lesaoPassada:
      'Joelho falta de cartilagem, ombro com bursite e tendinite, cotovelo epicondilite',
    limitacaoFisica: 'Lombar, joelho, ombro e cotovelo',
    amamentando: '',
    ...
    pesoPretendido: 64,
    pesoAtual: 52.9,
    porcentagemDeGorduraBia: 27.1,
    massaMuscularBia: 31.4,
    idadeCorporal: 38,
    gorduraVisceral: 5,
    tmb: 1316,
    circunferenciaDePunho: 15,
    circunferenciaDeAbdomen: 78,
    circunferenciaDePescoco: 32.5,
    circunferenciaDeCintura: 71,
    circunferenciaDeQuadril: 93,
    circunferenciaDePanturrilha: 34.5,
    circunferenciaBracoRelaxado: 27,
    circunferenciaBracoContraido: 30,
    circunferenciaTorax: 'hide',
    circunferenciaAntebraco: 23,
    circunferenciaCoxa: 55,
    circunferenciaTornozelo: 'hide',
    dobraCutaneaAxilarMedia: 10,
    dobraCutaneaPeitoral: 9,
    dobraCutaneaAbdominal: 20,
    dobraCutaneaTricipital: 13,
    dobraCutaneaSubescapular: 26,
    dobraCutaneaSuprailiaca: 14,
    dobraCutaneaCoxa: 17,
    dobraCutaneaPanturrilha: 11,
    planejaRefeicoes: 'Sim',
    preparaRefeicoes: 'Sim',
    numeroRefeicoes: '4 - 5 vezes por semana',
    quantidadeAgua: '2l no mínimo',
    horarioFome: 'a tarde',
    alimentoBeliscar: 'Chocolate, bolacha, pão',
    alimentosFrequentes:
      'Carne, frango, ovos, Arroz, Pão de forma',
    restricaoAlimentar: 'Sem restrições',
    velocidadeMastigar: '',
    usaSuplementos: 'Não',
    consumoAlimentarDiario:
      'Café: [Pão com ovo, café com leite, 1 fruta], Colação: [1 banana ou bolacha ou pão com mnteig], Almoço: [carne moída, batat doce, arroz, feijão e salada], Lanche da tarde: [Pão com manteiga], Lanche da tarde 2: [Fruta ou pão com queijo], Lanche da noite: [pão com carne moída e salada de fruta], Jantar = [pão com queijo]',
    habitosFinaisDeSemana: 'Geralmente janta fora da rotina',
    desvioPostural: 'Não possui',
    informacoesAdicionais:
      'Perna mais grossa, bumbum mais empinado',
  };
