...
function ResultadoAvaliacaoFisica() {
  const dadosDaAvaliacaoAtual = {
    ...
    genero: 'masculino',
    objetivoEstetico: 'Pós bariatrico',
    pontosFracosEsteticos: 'dificuldade em emagrecer',
    pretendeCorrer: 'Não',
    objetivosComCorrida: '',
    ...
    motivoDeParadaDaUltimaVez: 'Compromissos da rotina',
    ...
    tempoUltimaRefeicao: '4h antes da avaliação',
    horaDeDormir: '10h00 ou 22h00',
    horaDeAcordar: '06h00 ou 16h00',
    qualidadeDoSono: 'Boa',
    rotinaDiariaDetalhes: 'Trabalho >  :Academia 3x > Estudo > Dorme',
    humorDiario: 'ansioso',
    estrategiasContraEstresse: 'Beber agua',
    estrategiasDeLazer: 'Tocar bateria, tocar baixo, ver séries, jogar xadrez',
    rotinaDeTrabalho: 'Tecnico de operações da petrobras - trabalho ativo e caminha de 12 a 8km em 12h',
    meioDeTransporteParaTrabalho: 'Fretado',
    problemasDeSaude: 'Varizes, apeneia, ansiedade depressiva, gordura no fígado, deslipidemi e obesidade',
    tomaMedicamento:
      'Diosmin SDU',
    usaEsteroides: 'Não',
    frequenciaAlcool: 'Não utiliza',
    frequenciaFumo: 'Não fuma',
    lesaoPassada: 'Joelho E, ligamento cruzado anterior em 2008',
    limitacaoFisica: 'Flexibilidade',
    amamentando: '',
    cirurgiaPassada: 'Remoção da safena de ambas as pernas',
    ...
    habitosFinaisDeSemana:
      'sem refeição fora',
    desvioPostural:
      'Escoliose, pisada pronada',
    informacoesAdicionais:
      'Foco principal é realizar a cirurgia bariatrica',
  };
