...
function ResultadoAvaliacaoFisica() {
  const dadosDaAvaliacaoAtual = {
    ...
    idade: 36,
    altura: 1.57,
    email: 'tici[underline]bs@outlook.com',
    ...
    motivoDeParadaDaUltimaVez: 'falta de gosto',
    ...
    ultimoTreino: '24 horas antes da musculação',
    ultimoTreinoDescricao: 'membros superiores',
    ultimaRefeicao: 'Risoto de camarão',
    tempoUltimaRefeicao: 'há quase de 22 horas',
    horaDeDormir: '22:00',
    horaDeAcordar: '05:00',
    qualidadeDoSono: 'Boa',
    rotinaDiariaDetalhes: 'Toma café,  treina, trabalha, pedala/passeia, estuda',
    humorDiario: 'ansioso',
    ...
    lesaoPassada: 'Não',
    limitacaoFisica: 'Joelho as vezes',
    amamentando: '',
    cirurgiaPassada: 'Video laparoscopia',
    tempoCirurgiaPassada: '5 anos',
    fcRepouso: 'hide',
    paRepouso: 'hide',
    spO2: '',
    ...
    tmb: 1316,
    planejaRefeicoes:
      'Tem um plano alimentar para ganho de massa de muscular, segue 70% do plano',
    preparaRefeicoes: 'Sim',
    numeroRefeicoes: '4 a 5 refeições',
    quantidadeAgua: '+2l',
    horarioFome: 'De manhã',
    alimentoBeliscar: 'Salgados, folhados, empanada de carne',
    alimentosFrequentes: 'Ovo, Arroz e peixe',
    restricaoAlimentar: 'curcuma',
    velocidadeMastigar: '',
    usaSuplementos:
      'Whey e Creatina, super coffe',
    consumoAlimentarDiario:
      'Vai mandar o pDF',
    habitosFinaisDeSemana:
      'Foge mas com consciência',
    desvioPostural:
      'Escoliose',
    informacoesAdicionais:
      'Sabrina sato é uma referência, corpo mais modelette, não gosta de correr, mas gosta de fazer aeróbio... quer levantar o gluteo, o braço quer mais definido,  quer mais definição nas costas... quer parecer que treina, gosta de treino misto misturando membros inferiores e superiores, quer mais definição nas coxas',
  };
