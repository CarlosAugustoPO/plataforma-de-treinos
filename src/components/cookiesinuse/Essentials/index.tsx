...
export default function EssentialsCookies() {
  return (
    ...
    >
      {/* {{{ Essentials 1*/}
      <Grid item xs={12}>
        <Caption sx={{ fontWeight: 600 }}>Cookie essencial 1</Caption>{" "}
        <Divider />
      </Grid>
      ...
      <Grid item xs={8}>
        <Caption>Comunica as ações do usuário entre as páginas</Caption>{" "}
      </Grid>
      <Grid item xs={4}>
      ...
      <Grid item xs={12}>
        <Divider />
        <Caption sx={{ fontWeight: 600 }}>Cookie essencial 2</Caption>{" "}
        <Divider />
      </Grid>
      <Grid item xs={4}>
        <Caption sx={{ fontWeight: 600 }}>Nome:</Caption>{" "}
      ...
      <Grid item xs={8}>
        <Caption>
          Informa padrões de redirecionamento para o serviço de autenticação
        </Caption>{" "}
      </Grid>
      <Grid item xs={4}>
        <Caption sx={{ fontWeight: 600 }}>Tipo:</Caption>{" "}
      ...
      <Grid item xs={12}>
        <Divider />
        <Caption sx={{ fontWeight: 600 }}>Cookie essencial 3</Caption>{" "}
        <Divider />
      </Grid>
      <Grid item xs={4}>
        <Caption sx={{ fontWeight: 600 }}>Nome:</Caption>{" "}
      ...
      <Grid item xs={8}>
        <Caption>Garante a autenticidade do usuário ao fazer o login</Caption>{" "}
      </Grid>
      <Grid item xs={4}>
        <Caption sx={{ fontWeight: 600 }}>Tipo:</Caption>{" "}
      </Grid>
      ...
      <Grid item xs={12}>
        <Divider />
        <Caption sx={{ fontWeight: 600 }}>Cookie essencial 4</Caption>{" "}
        <Divider />
      </Grid>
      <Grid item xs={4}>
        <Caption sx={{ fontWeight: 600 }}>Nome:</Caption>{" "}
      ...
      <Grid item xs={8}>
        <Caption>
          Garante a funcionalidade de recursos de acessibilidade do navegador
        </Caption>{" "}
      </Grid>
      <Grid item xs={4}>
        <Caption sx={{ fontWeight: 600 }}>Tipo:</Caption>{" "}
